// Webcam hand-gesture tracking (pinch-to-spin, dual-pinch-to-zoom) — adapted from the
// ULTRON Orb UI project (github.com/SAGAR-TAMANG/ultron-by-sagar-builds, MIT licensed),
// ported from lib/handTracker.ts to plain JS (TypeScript types stripped, logic unchanged).
// Wired to orbScene.js's rotateBy/zoomBy via onRotate/onZoom callbacks.
